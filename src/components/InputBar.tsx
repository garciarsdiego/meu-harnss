...
import { MhSkillsControl } from "../../renderer/src/features/pal/MhSkillsControl";
import { MhAgentDropdown } from "../../renderer/src/features/pal/MhAgentDropdown";
      ...
      >
        ...
        <div className="flex items-center gap-1 px-3 pb-2.5">
          ...
          <div className="flex min-w-0 flex-1 items-center gap-1 overflow-x-auto scrollbar-none">
            ...
            <MhSkillsControl onApply={(text) => insertTextAtCursor(editableRef.current, text)} />
            <MhAgentDropdown />
